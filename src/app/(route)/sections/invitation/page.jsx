...
import { Box, Text, Button, Grid, GridItem, Image, VStack } from "@chakra-ui/react";
...
const InvitationSection = () => {
    return (
        ...
        <Text fontSize={{ base: "md", md: "lg" }} maxW="600px">
           Become a part of CoinMaster's journey. Support the vision, access exclusive benefits, and shape the future of web3 superhero narratives!
        </Text>
        {/* Button  */}
